...
RUN python3 -m pip install --target /usr/irissys/mgr/python torch torchvision -i https://pypi.tuna.tsinghua.edu.cn/simple --trusted-host pypi.tuna.tsinghua.edu.cn
RUN python3 -m pip install --target /usr/irissys/mgr/python sentence_transformers -i https://pypi.tuna.tsinghua.edu.cn/simple --trusted-host pypi.tuna.tsinghua.edu.cn
